...
<!-- ===== V8: SCROLL-SNAP / MAGAZINE ===== -->
<!-- Обёртка лендинга: scroll-snap живёт ТОЛЬКО здесь, не на body -->
<div class="v8-deck" id="v8Deck">

  <!-- Индикатор прогресса скролла -->
  <div class="v8-progress" id="v8Progress" aria-hidden="true"><span></span></div>

  <!-- Точки-навигация секций (справа) -->
  <nav class="v8-dots" id="v8Dots" aria-label="Навигация по секциям">
    <a href="#hero" class="v8-dot is-active" data-target="hero"><span class="v8-dot-label">Главное</span></a>
    <a href="#catalog" class="v8-dot" data-target="catalog"><span class="v8-dot-label">Каталог</span></a>
    <a href="#how" class="v8-dot" data-target="how"><span class="v8-dot-label">Как это работает</span></a>
    <?php if ($reviews): ?>
    <a href="#reviews" class="v8-dot" data-target="reviews"><span class="v8-dot-label">Отзывы</span></a>
    <?php endif; ?>
    <a href="#cta" class="v8-dot" data-target="cta"><span class="v8-dot-label">Заявка</span></a>
  </nav>

  <!-- ===== HERO ===== -->
  <section class="hero v8-snap v8-screen" id="hero">
    <div class="hero-bg"></div>
    <span class="v8-folio">01 — Главное</span>
    ...
    <a href="#catalog" class="v8-scroll-hint" aria-label="Листать вниз"><span></span></a>
  </section>

  <!-- ===== КАТАЛОГ (горизонтальная карусель карточек со snap) ===== -->
  <section class="section v8-snap v8-screen v8-catalog" id="catalog">
    <div class="container">
      <div class="section-head reveal">
        <span class="v8-folio v8-folio--inline">02 — Каталог</span>
      ...
      <div class="v8-rail">
        <button class="v8-rail-btn v8-rail-prev" id="v8RailPrev" aria-label="Назад" type="button">‹</button>
        <div class="cards-grid v8-track" id="catalogGrid">
        ...
        <button class="v8-rail-btn v8-rail-next" id="v8RailNext" aria-label="Вперёд" type="button">›</button>
      </div>
    </div>
  </section>

  <!-- ===== КАК ЭТО РАБОТАЕТ ===== -->
  <section class="section section-alt v8-snap v8-screen" id="how">
    <div class="container">
      <div class="section-head reveal">
        <span class="v8-folio v8-folio--inline">03 — Процесс</span>
  ...
  <!-- ===== ОТЗЫВЫ ===== -->
  <?php if ($reviews): ?>
  <section class="section v8-snap v8-screen" id="reviews">
    <div class="container">
      <div class="section-head reveal">
        <span class="v8-folio v8-folio--inline">04 — Отзывы</span>
  ...
  <!-- ===== CTA ===== -->
  <section class="cta-band v8-snap v8-screen v8-screen--cta reveal" id="cta">
