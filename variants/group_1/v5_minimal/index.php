  ...
  <div class="container hero-inner">
    ...
    <div class="hero-card reveal">
      ...
      <div class="mini-booking">
        ...
        <div class="mini-row"><span>Категории</span><b><?= e(implode(' · ', $CONFIG['categories'])) ?></b></div>
        <div class="mini-row"><span>Оплата</span><b>QR · МИР · офис</b></div>
        <a href="<?= current_user() ? 'booking.php' : 'register.php' ?>" class="btn btn-outline btn-block">Оформить заявку</a>
      </div>
    </div>
  </div>
</section>
