...
<section class="hero">
  ...
  <div class="container hero-inner">
    <div class="hero-text reveal">
      <span class="hero-badge" data-glitch>✦ <?= e($CONFIG['tagline']) ?></span>
  ...
  <!-- V7: бегущая строка (marquee) — наполняется variant.js -->
  <div class="nb-marquee reveal" data-marquee aria-hidden="true">
    <div class="nb-marquee-track">
      <span><?= e($CONFIG['catalog_title']) ?> ✦ <?= e($CONFIG['cta']) ?> ✦ <?= e(implode(' ✦ ', $CONFIG['categories'])) ?> ✦&nbsp;</span>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="cards-grid" id="catalogGrid">
      <?php foreach ($items as $it): ?>
        <article class="card reveal" data-cat="<?= e($it['category']) ?>" data-tilt>
